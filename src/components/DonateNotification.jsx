    ...
    <AnimatePresence>
      {isVisible && (
          <motion.div
            ...
            className="fixed bottom-6 right-6 z-50 max-w-sm w-[calc(100%-3rem)] bg-white/95 backdrop-blur-xl rounded-lg shadow-[0_20px_40px_rgba(0,0,0,0.15)] border border-white/40 overflow-hidden"
          >
            ...
            <div className="p-5 flex items-start gap-4">
              <div className="bg-yellow-50 text-yellow-500 p-3 rounded-lg shrink-0">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-3">
                  <Link
                    to="/donate"
                    onClick={handleClose}
                    className="bg-yellow-500 hover:bg-yellow-400 text-slate-900 text-sm font-bold px-5 py-2 rounded-lg transition-colors shadow-sm"
                  >
                    Donate Now
                  </Link>
                <button
