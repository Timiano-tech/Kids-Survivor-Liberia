        ...
        {isOpen && (
          ...
          >
              ...
              <div key={item.name} className="py-2">
                {item.dropdown ? (
                  <details className="group">
                    <summary className="flex justify-between items-center text-gray-700 font-medium py-2 cursor-pointer">
                      {item.name}
            ...
            <Link to="/donate" className="mt-4 block" onClick={() => setIsOpen(false)}>
              <button className="w-full bg-red-500 hover:bg-red-600 text-white py-2 rounded-lg font-semibold">
                Donate Now
              </button>
            </Link>
          </motion.div>
