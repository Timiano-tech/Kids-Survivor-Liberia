...
export const COUNTIES = [
  ...
  },
  {
    ...
    images: [],
    office: {
      name: 'Robertsport Office',
      focusArea: 'Border Protection & Youth',
      coordinator: 'Regional Coordinator',
      phone: '+231XXXXXXX',
    },
  },
  {
    ...
    tagline: 'Zwedru City outreach, post-conflict healing, and community cohesion.',
  ...
  },
  {
    ...
    images: [],
    office: {
      name: 'Barclayville Office',
      focusArea: 'Rural Protection',
      coordinator: 'Regional Coordinator',
      phone: '+231XXXXXXX',
    },
  },
  {
    ...
    images: [],
    office: {
      name: 'Harper City Office',
      focusArea: 'Child & Girl Protection',
      coordinator: 'Regional Coordinator',
      phone: '+231XXXXXXX',
    },
  },
  {
    ...
    images: [],
    office: {
      name: 'Fish Town Office',
      focusArea: 'Community Prevention',
      coordinator: 'Regional Coordinator',
      phone: '+231XXXXXXX',
    },
  },
  {
    ...
    images: [],
    office: {
      name: 'Cestos City Office',
      focusArea: 'Riverine Outreach',
      coordinator: 'Regional Coordinator',
      phone: '+231XXXXXXX',
    },
  },
  {
    ...
    office: {
      ...
      focusArea: 'Drug Demand Reduction',
      coordinator: 'Regional Coordinator',
      phone: '+231XXXXXXX',
    },
  },
  {
    ...
    office: {
      name: 'Bopolu Office',
      focusArea: 'Mining Community Care',
      coordinator: 'Regional Coordinator',
      phone: '+231XXXXXXX',
    },
  },
  {
    ...
    images: [],
    office: {
      name: 'Tubmanburg Office',
      focusArea: 'Youth Inclusion',
      coordinator: 'Regional Coordinator',
      phone: '+231XXXXXXX',
    },
  },
